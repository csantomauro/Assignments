...
***************/
	...
	A->Triangle(-0.25, 0.1, 0.11, -0.4, 0.11, 0.6, 1, 0, 0); //triangolo rosso
	A->Triangle(0.12, -0.4, 0.12, 0.32, 0.38, -0.037,  1, 1, 0); //braccia gialle
	A->Triangle(-0.25, 0.1, -0.25, 0.85, 0.25, 0.85, 0, 0, 1); //gambe blu
	A->Triangle(0.12, -0.4, 0.3, -0.15, 0.3, -0.65, 1, 0, 1);//testa sinistra 
	A->Triangle(0.48, -0.4, 0.3, -0.15, 0.3, -0.65, 1, 0, 1);//testa destra
	A->Triangle(0.12, -0.4, 0.3, -0.65, 0.12, -0.9, 1, 0.75, 0.8);//orecchio sinistro
	A->Triangle(0.3, -0.65, 0.48, -0.4, 0.48, -0.9, 0.5, 0.8, 0.9);//orecchio destro
	A->Triangle(-0.25, 0.85, -0.43, 0.6, -0.63, 0.85, 0.45, 0.57, 0.13);//coda destra
	A->Triangle(-0.81, 0.6, -0.43, 0.61, -0.63, 0.85, 0.45, 0.57, 0.13);//coda sinistra
