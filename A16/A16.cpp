...
/* A16 */
/* Add the C++ datastructure for the required vertex format DONE */
...
protected:
	...
	/* A16 */
	/* Add the variable that will contain the required Descriptor Set Layout DONE*/
	DescriptorSetLayout DSLVColor;
	// Vertex formats
	VertexDescriptor VMesh;
	VertexDescriptor VOverlay;
	/* A16 */
	/* Add the variable that will contain the required Vertex format definition DONE*/
	VertexDescriptor VVColor;
	// Pipelines [Shader couples]
	Pipeline PMesh;
	Pipeline POverlay;
	/* A16 */
	/* Add the variable that will contain the new pipeline DONE*/
	Pipeline PVColor;
	// Models, textures and Descriptors (values assigned to the uniforms)
	// Please note that Model objects depends on the corresponding vertex structure
	Model<VertexMesh> MBody, MHandle, MWheel;
	/* A16 */
	/* Add the variable that will contain the model for the room DONE*/
	...
	/* A16 */
	/* Add the variable that will contain the Descriptor Set for the room DONE*/
	...
	/* A16 */
	/* Add the variable that will contain the Uniform Block in slot 0, set 1 of the room DONE*/
	...
	void setWindowParameters() {
		...
		/* A16 */
		/* Update the requirements for the size of the pool DONE*/
	...
	void localInit() {
		...
		/* A16 */
		/* Init the new Data Set Layout DONE*/
		DSLVColor.init(this, {
					{0, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, VK_SHADER_STAGE_ALL_GRAPHICS}
			});
		DSLGubo.init(this, {
		...
		/* A16 */
		/* Define the new Vertex Format DONE*/
		VVColor.init(this, {
		...
		/* A16 */
		/* Create the new pipeline, using shaders "VColorVert.spv" and "VColorFrag.spv" DONE*/
		...
		/* A16 */
		/* load the mesh for the room, contained in OBJ file "Room.obj" DONE*/
	...
	void pipelinesAndDescriptorSetsInit() {
		...
		/* A16 */
		/* Define the data set for the room DONE*/
	...
	void pipelinesAndDescriptorSetsCleanup() {
		...
		DSWheel3.cleanup();
		/* A16 */
		/* cleanup the dataset for the room DONE*/
		DSRoom.cleanup();
		DSKey.cleanup();
		DSSplash.cleanup();
		DSGubo.cleanup();
	...
	void localCleanup() {
		...
		MSplash.cleanup();
		/* A16 */
		/* Cleanup the mesh for the room DONE*/
		MRoom.cleanup();
		// Cleanup descriptor set layouts
		DSLMesh.cleanup();
		DSLOverlay.cleanup();
		/* A16 */
		/* Cleanup the new Descriptor Set Layout DONE*/
		DSLVColor.cleanup();
		DSLGubo.cleanup();
	...
	void populateCommandBuffer(VkCommandBuffer commandBuffer, int currentImage) {
		...
		vkCmdDrawIndexed(commandBuffer,
			static_cast<uint32_t>(MWheel.indices.size()), 1, 0, 0, 0);
		/* A16 */
		/* Insert the commands to draw the room DONE?*/
...
//std::cout << gameState << "\n";	
		...
		/* A16 */
		/* fill the uniform block for the room. Identical to the one of the body of the slot machine DONE*/
		World = glm::mat4(1);
		...
		/* map the uniform data block to the GPU DONE*/
